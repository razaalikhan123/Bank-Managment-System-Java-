...
public class F7 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"LOAN REQUEST PROCCEDED");
        ...
        else if(income1>=1000001){
            payment=loan1+interestval+12000;
        JOptionPane.showMessageDialog(null,"LOAN REQUEST PROCCEDED");
                                
        }
        else if  (income1 <= 999){
        JOptionPane.showMessageDialog(null,"LOAN REQUEST REJECTED. LOW INCOME");
